...
const brand_popup = (id, field = undefined) =>{
    const term  = "brand";
...
const remove_brand_notifier = term => {
    notifier(`${term}_name`)
}
const add_update_brand = (id, field) =>{
    event.preventDefault();
    const term  = "brand";
    let check   = true;
    remove_brand_notifier(term)
    if($(`#${term}_name`).val() == ''){
