    ...
    <tbody id="payment_material_wrapper">
        <?php foreach ($trans_data as $key => $value): ?>
            <tr id="rowid_<?php echo $value['vt_pm_id'] ?>" class="floating-form">
                ...
                <td class="floating-label">
                    <input type="number" class="form-control floating-input" name="vt_allocated_amt[]" id="vt_allocated_amt_<?php echo $value['vt_pm_id'] ?>" value="<?php echo $value['vt_allocated_amt']; ?>" readonly />
                </td>
                <td class="floating-label">
                    <input type="number" class="form-control floating-input" name="vt_allocated_round_off[]" id="vt_allocated_round_off_<?php echo $value['vt_pm_id'] ?>" value="<?php echo $value['vt_allocated_round_off']; ?>" readonly />
                </td>
                <td class="floating-label">
                    <input type="number" class="form-control floating-input" name="vt_adjust_amt[]" id="vt_adjust_amt_<?php echo $value['vt_pm_id'] ?>" value="<?php echo $value['vt_adjust_amt']; ?>" readonly />
                </td>
                <td class="floating-label">
                    <input type="number" class="form-control floating-input" name="vt_adjust_round_off[]" id="vt_adjust_round_off_<?php echo $value['vt_pm_id'] ?>" value="<?php echo $value['vt_adjust_round_off']; ?>" readonly />
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
