<?php 
    ...
    $purchase_area  = empty($master_data) ? "" : "d-none";
    $pur_sale_area  = !empty($master_data) && $master_data[0]['vm_group'] == 'CUSTOMER' ? "SALES" : "PURCHASE";
    $return_area    = "d-none";
...
<script>
    let link = "voucher";
    let sub_link = "payment";
</script>
<section class="d-flex justify-content-between sticky_top neu_flat_primary breadcrumb_pagination">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo base_url('voucher/payment?action=view'); ?>">PAYMENT</a></li>
        ...
        <li class="breadcrumb-item" aria-current="cancel-page">
            <a type="button" class="btn btn-sm btn-primary" href="<?php echo base_url('voucher/payment?action=view')?>" data-toggle="tooltip" data-placement="bottom" title="CANCEL" tabindex="9"><i class="text-danger fa fa-close"></i></a>
        </li>
      </ol>
    </nav>
</section>
		...
		<div class="row">
					...
					<div class="card-body">
						<div class="d-flex flex-wrap mt-2 form-group floating-form">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-6 floating-label">
                                ...
                                <?php echo form_dropdown('', $groups, empty($master_data) ? 'SUPPLIER' : $master_data[0]['vm_group'],'class="form-control floating-select" id="vm_group" name="vm_group" onchange="set_party()"'.$disabled);?>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 floating-label">
                                ...
                                <select class="form-control floating-select" id="vm_party_id" name="vm_party_id" placeholder="" tabindex="2" onchange="validate_dropdown(this)" <?php echo $disabled; ?>>
                                    <?php if(!empty($master_data)): ?>
			...
			<div class="col-sm-12 col-md-6">
				<div class="card mb-3">
					<div class="card-header d-flex justify-content-between">
                        ...
                        <?php if((!empty($master_data) && $master_data[0]['vm_group'] == 'SUPPLIER') && empty($trans_data)): ?>
					...
					<div class="card-body">
						<div class="d-flex flex-wrap mt-2 form-group floating-form">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4 floating-label">
                                ...
                                <?php else: ?>
                                    <input type="number" class="form-control floating-input" id="vm_round_off" name="vm_round_off" value="<?php echo empty($master_data) ? 0 : $master_data[0]['vm_round_off'] ?>" placeholder=" " value="0" min="0" oninput="this.value = Math.abs(this.value)" onkeyup="calculate_master_balance()" tabindex="6"/>
                                <?php endif; ?>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-8 floating-label">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-4 floating-label purchase_area <?php echo $purchase_area; ?>">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-4 floating-label return_area <?php echo $return_area; ?>">
			...
			<div class="col-sm-12">
				<div class="card mb-3 wrapper_area <?php echo $wrapper_area; ?>">
					<div class="card-header">PURCHASE DETAIL</div>
					<div class="card-body mt-2">
						<table class="table table-hover table-sm table-responsive" id="voucher_material_wrapper">
                            <?php if(!empty($master_data)): ?>
                                <?php if($master_data[0]['vm_constant'] == 'DEBIT_NOTE'): ?>
                                    <?php $this->view('pages/voucher/payment_trans_debit'); ?>
                                <?php else:?>
                                    <?php $this->view('pages/voucher/payment_trans'); ?>
                                <?php endif;?>
                            <?php endif;?>
						</table>
					</div>
...
<script src="<?php echo assets('dist/js/voucher/payment.js?v=1')?>"></script>
