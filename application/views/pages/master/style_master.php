...
<section class="container-fluid sticky_top">
	<form class="form-horizontal" id="search_form" action="<?php echo base_url('master/style?action=view')?>" method="get">
			...
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item" aria-current="add-page">
			    	<a type="button" class="btn btn-sm btn-primary" onclick="style_popup(0)" data-toggle="tooltip" data-placement="bottom" title="ADD NEW"><i class="text-success fa fa-plus"></i></a>
			    </li>
			    ...
			    <li class="breadcrumb-item" aria-current="refresh-page">
			    	<button type="button" class="btn btn-sm btn-primary" onclick="redirectPage('master/style?action=view')" data-toggle="tooltip" data-placement="bottom" title="REFRESH"><i class="text-info fa fa-undo"></i></button>
			    </li>
				...
				<tbody id="table_tbody">
					...
					?>
								...
								<tr>
									...
									<td width="10%">
										<a type="button" class="btn btn-sm btn-primary" onclick="style_popup(<?php echo $value['id']; ?>)">
