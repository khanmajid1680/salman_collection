...
<script>
    let link 	= "report";
    let sub_link= "customer_mis";
</script>
<section class="container-fluid sticky_top">
	<form class="form-horizontal" id="search_form" action="<?php echo base_url('report/customer_mis?action=view')?>" method="get">
			...
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item" aria-current="reload-page">
			    	<a type="button" class="btn btn-sm btn-primary" onclick="redirectPage('report/customer_mis?action=view')" data-toggle="tooltip" data-placement="bottom" title="REFRESH"><i class="text-info fa fa-undo"></i></a>
			    </li>
				...
				<table class="table table-sm table-dark">
					...
					<tbody>
						<tr style="font-size: 15px; font-weight: bold;">
                            ...
                            <td ><?php echo round($data['totals']['received_amt'], 2); ?></td>
				...
				<tbody>
					...
					?>
								<tr>
									...
									<td width="10%"><?php echo round($value['received_amt'], 2); ?></td>
...
<?php $this->load->view('templates/footer'); ?>
		<script src="<?php echo assets('dist/js/report/customer_mis.js')?>"></script>
	</body>
</html>