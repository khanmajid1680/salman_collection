...
<script>
    let link 	= "report";
    let sub_link= "vip_stock";
</script>
<section class="container-fluid sticky_top">
	<form class="form-horizontal" id="search_form" action="<?php echo base_url('report/vip_stock?action=view')?>" method="get">
		<div class="d-flex justify-content-between">
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    <li class="breadcrumb-item active" aria-current="page">
			    	BARCODE(VIP) STOCK(<span><i><?php echo $total_rows;?></i></span>)
			    </li>
			    ...
			    <li class="breadcrumb-item" aria-current="refresh-page">
			    	<a type="button" class="btn btn-sm btn-primary" onclick="redirectPage('report/vip_stock?action=view')" data-toggle="tooltip" data-placement="bottom" title="REFRESH"><i class="text-info fa fa-undo"></i></a>
			    </li>
			    <li class="breadcrumb-item" aria-current="print-page">
			    	<?php if(!empty($data['data'])): ?>
			    		<a target="_blank" type="button" class="btn btn-sm btn-primary mr-2" data-toggle="tooltip" data-placement="bottom" title="PDF" href="<?php echo base_url("report/vip_stock?submit=PDF&$url"); ?>">
		...
		<div class="row collapse mt-2 <?php echo empty($search_status) ? '' : 'show'  ?>" id="search_box">
			<div class="d-flex flex-wrap justify-content-center floating-form">
				...
				<div class="d-flex mt-2 col-6 col-sm-4 col-md-3 col-lg-2">
					<div class="floating-label">
						<input type="number" class="form-control floating-input" id="st_rate_frm" name="st_rate_frm" value="<?php echo $st_rate_frm ?>" placeholder=" " autocomplete="off"/>   
	                    <label for="inputEmail3">FROM SALE RATE</label>
					</div>
					<div class="floating-label">
						<input type="number" class="form-control floating-input" id="st_rate_to" name="st_rate_to" value="<?php echo $st_rate_to ?>" placeholder=" " autocomplete="off"/>   
	                    <label for="inputEmail3">TO SALE RATE</label>
					</div>
				</div>
				<div class="d-flex mt-2 col-6 col-sm-4 col-md-3 col-lg-2">
					<div class="floating-label">
				...
				<div class="d-flex mt-2 col-6 col-sm-4 col-md-3 col-lg-2">
					<div class="floating-label">
	                    ...
	                    <label for="inputEmail3">FROM BAL QTY</label>
					</div>
					<div class="floating-label">
				...
				<div class="d-flex mt-2 col-6 col-sm-4 col-md-3 col-lg-3">
					<div class="floating-label">
	                    ...
	                    <label for="inputEmail3">FROM STOCK AMT</label>
					</div>
					<div class="floating-label">
				...
				<div class="d-flex mt-2 col-6 col-sm-4 col-md-3 col-lg-3">
					<div class="floating-label">
						<input type="number" class="form-control floating-input" id="profit_frm" name="profit_frm" value="<?php echo $profit_frm ?>" placeholder=" " autocomplete="off"/>   
	                    <label for="inputEmail3">FROM PROFIT AMT</label>
					</div>
					<div class="floating-label">
						<input type="number" class="form-control floating-input" id="profit_to" name="profit_to" value="<?php echo $profit_to ?>" placeholder=" " autocomplete="off"/>   
	                    <label for="inputEmail3">TO PROFIT AMT</label>
					</div>
				</div>
			</div>
		</div>
			...
			<table class="table table-sm table-hover">
				<tbody>
					...
					?>
								<tr>
									<td width="10%">
										<a target="_blank" href="<?php echo base_url('master/barcode?action=print&id='.$value['bm_id']) ?>" data-toggle="tooltip" data-placement="bottom" title="PRINT">
...
<?php $this->load->view('templates/footer'); ?>
	<script src="<?php echo assets('dist/js/report/vip_stock.js')?>"></script>
	</body>
</html>