			...
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    <li class="breadcrumb-item active" aria-current="page">
			    	SALES SUMMARY(<span><i><?php echo $total_rows;?></i></span>)
			    </li>
			    ...
			    <li class="breadcrumb-item" aria-current="reload-page">
			    	<a type="button" class="btn btn-sm btn-primary" onclick="redirectPage('report/sales_summary?action=view')" data-toggle="tooltip" data-placement="bottom" title="REFRESH"><i class="text-info fa fa-undo"></i></a>
			    </li>
			    <li class="breadcrumb-item" aria-current="print-page">
			    	<?php if(!empty($data['data'])): ?>
			    		<a target="_blank" type="button" class="btn btn-sm btn-primary mr-2" data-toggle="tooltip" data-placement="bottom" title="PDF" href="<?php echo base_url("report/sales_summary?submit=PDF&$url"); ?>">
				...
				<tbody>
					...
					?>
								<tr>
									...
									<td width="7%"><?php echo round($value['sm_total_qty'], 0); ?></td>
									<td width="7%"><?php echo round($value['sm_sub_total'], 2); ?></td>
									<td width="7%"><?php echo round($value['sm_total_disc'], 2); ?></td>
									<td width="7%"><?php echo round($value['sm_taxable_amt'], 2); ?></td>
									<td width="10%"><?php echo round($value['sm_point_used'], 2); ?></td>
									<td width="7%"><?php echo round($value['sm_round_off'], 2); ?></td>
...
<?php $this->load->view('templates/footer'); ?>
		<script src="<?php echo assets('dist/js/report/sales_summary.js?v=1')?>"></script>
	</body>
</html>