...
<script>
    let link 	= "report";
    let sub_link= "purchase_summary_itemwise";
</script>
<section class="container-fluid sticky_top">
	<form class="form-horizontal" id="search_form" action="<?php echo base_url('report/purchase_summary_itemwise?action=view')?>" method="get">
		<div class="d-flex justify-content-between">
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    <li class="breadcrumb-item"><a href="<?php echo base_url('report/purchase_summary_itemwise?action=view'); ?>">REPORT</a></li>
			    <li class="breadcrumb-item active" aria-current="page">
			    	PURCHASE SUMMARY ITEMWISE(<span><i><?php echo $total_rows;?></i></span>)
			    </li>
			    ...
			    <li class="breadcrumb-item" aria-current="refresh-page">
			    	<a type="button" class="btn btn-sm btn-primary" onclick="redirectPage('report/purchase_summary_itemwise?action=view')" data-toggle="tooltip" data-placement="bottom" title="REFRESH"><i class="text-info fa fa-undo"></i></a>
			    </li>
			     <li class="breadcrumb-item" aria-current="print-page">
			    	<?php if(!empty($data['data'])): ?>
			    		<a target="_blank" type="button" class="btn btn-sm btn-primary mr-2" data-toggle="tooltip" data-placement="bottom" title="EXCEL" href="<?php echo base_url("report/purchase_summary_itemwise/excel?$url"); ?>">
				...
				<tbody>
					...
					?>
								<tr>
									...
									<td width="5%"><?php echo $value['pm_bill_no']; ?>
									...
									<td width="5%"><?php echo date('d-m-Y', strtotime($value['pm_bill_date'])); ?></td>
									...
									<td width="7%"><?php echo $value['pt_qty']; ?></td>
									<td width="7%"><?php echo round($value['pt_rate'], 2); ?></td>
									<td width="7%"><?php echo round($value['pt_sub_total'], 2); ?></td>
									<td width="5%"><?php echo round($value['pt_disc_amt'], 2); ?></td>
									<td width="8%"><?php echo round($value['pt_taxable_amt'], 2); ?></td>
									<td width="7%"><?php echo round($value['pt_sgst_amt'], 2); ?><br/><span style="font-size: 12px"><?php echo $value['pt_sgst_per']?>%</span></td>
									<td width="7%"><?php echo round($value['pt_cgst_amt'], 2); ?><br/><span style="font-size: 12px"><?php echo $value['pt_cgst_per']?>%</span></td>
									<td width="7%"><?php echo round($value['pt_igst_amt'], 2); ?><br/><span style="font-size: 12px"><?php echo $value['pt_igst_per']?>%</span></td>
									<td width="8%"><?php echo round($value['pt_sub_total_amt'], 2); ?></td>
									<td width="7%"><?php echo round($value['pt_sp_amt'], 2); ?></td>
									<td width="7%"><?php echo round($value['pt_mrp'], 2); ?></td>
									<td width="7%"><?php echo round($value['pt_token_amt'], 2); ?></td>
...
<?php $this->load->view('templates/footer'); ?>
	<script src="<?php echo assets('dist/js/report/purchase_summary_itemwise.js')?>"></script>
	</body>
</html>