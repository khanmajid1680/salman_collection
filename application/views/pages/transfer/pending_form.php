                                ...
                                ?>
                                        <tr id="rowid_<?php echo $outward_cnt; ?>" class="floating-form" >
                                            <td>
                                                ...
                                                <input type="hidden" name="gt_bm_id[]" id="gt_bm_id_<?php echo $outward_cnt ?>" value="<?php echo $value['ot_bm_id']; ?>" />
                                                <input type="hidden" name="gt_id[]" id="gt_id_<?php echo $outward_cnt ?>" value="0" />
                                            </td>          

                                            <td>
                                                <input type="number" class="form-control floating-input" name="gt_bill_no[]" id="gt_bill_no_<?php echo $outward_cnt ?>" value="<?php echo $value['ot_bill_no'] ?>" readonly />
                                                <input type="hidden" name="gt_pm_id[]" id="gt_pm_id_<?php echo $outward_cnt ?>" value="<?php echo $value['ot_pm_id'] ?>" />
                                            </td>

                                            <td>
                                                <input type="text" class="form-control floating-input" name="gt_bill_date[]" id="gt_bill_date_<?php echo $outward_cnt ?>" value="<?php echo date('d-m-Y', strtotime($value['ot_bill_date'])) ?>" readonly />
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="gt_design_id[]" id="gt_design_id_<?php echo $outward_cnt ?>" value="<?php echo $value['ot_design_id'] ?>" />
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="gt_style_id[]" id="gt_style_id_<?php echo $outward_cnt ?>" value="<?php echo $value['ot_style_id'] ?>" />
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="gt_brand_id[]" id="gt_brand_id_<?php echo $outward_cnt ?>" value="<?php echo $value['ot_brand_id'] ?>" />
                                            </td>
                                            <td>
