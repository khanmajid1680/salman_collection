...
$account_code 		= isset($_GET['bm_acc_id']) && !empty($_GET['bm_acc_id']) ? $data['data'][0]['account_code'] : '';
...
$tbl .= <<<EOD
	...
	<table cellpadding="2">
		<tr>
			<td align="center" style="font-size:10px;"><b>BARCODE STOCK</b> (<span style="font-size:10px;">$branch</span>)</td>
		</tr>		
		<tr>
			<td>
				<table border="1" style="font-size:10px;">
					<tr>
						<td width="40%">SUPPLIER : $account_code</td>
