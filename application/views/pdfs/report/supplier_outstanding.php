...
$file_name = "SUPPLIER OUTSTANDING";
...
$credit_to 		= (isset($_GET['credit_to']) && $_GET['credit_to'] != '') ? " TO ".$_GET['credit_to'] : "";
$credited_frm 	= (isset($_GET['credited_frm'])) ? $_GET['credited_frm'] : "";
$credited_to 	= (isset($_GET['credited_to']) && $_GET['credited_to'] != '') ? " TO ".$_GET['credited_to'] : "";
...
$tbl .= <<<EOD
	...
	<table cellpadding="2">
		<tr>
			<td align="center" style="font-size:10px;"><b>SUPPLIER OUTSTANDING</b> (<span style="font-size:10px;">$branch</span>)</td>
		</tr>		
		<tr>
			<td>
				<table border="1" style="font-size:10px;">
					<tr>
						<td width="25%">SUPPLIER : $account_name</td>
						<td width="25%">PUR AMT : $credit_frm $credit_to</td>
						<td width="25%">PAYMENT AMT : $credited_frm $credited_to</td>
			...
			<td>
				<table border="1" style="font-size:9px;">
					<tr>
	                    ...
	                    <th width="18%">PURCHASE RETURN AMT</th>
	                    <th width="13%">DEBIT NOTE AMT</th>
					...
					if(!empty($data['data'])):
						...
						foreach ($data['data'] as $key => $value):
							...
							<tr>
								...
								<td width="7%">$account_drcr</td>
								<td width="10%">$open_amt</td>
								<td width="12%">$debit_amt</td>
								<td width="10%">$debited_amt</td>
								<td width="18%">$credit_amt</td>
								<td width="13%">$credited_amt</td>
