...
class design extends CI_Controller{
	...
	public function __construct(){
		...
		$this->load->model('master/designmdl', 'model');
	...
	public function add_update($id){
		...
		$post_data[$this->term.'_sgst_per'] 	= trim($post_data[$this->term.'_sgst_per']);
		$post_data[$this->term.'_cgst_per'] 	= trim($post_data[$this->term.'_cgst_per']);
		$post_data[$this->term.'_igst_per'] 	= trim($post_data[$this->term.'_igst_per']);
